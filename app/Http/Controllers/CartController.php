...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request){
        ...
        if($already_cart) {
            ...
            $already_cart->point_amount = $product->point + $already_cart->point_amount;
            ...
            $cart->quantity = 1;
            $cart->point =  $product->point;
            $cart->point_amount = $cart->point * $cart->quantity;
    ...
    public function singleAddToCart(Request $request){
        ...
        if($already_cart) {
            ...
            $already_cart->point_amount = ($product->point * $request->quant[1])+ $already_cart->point_amount;
            ...
            $cart->point = $product->point;
            $cart->point_amount = ($product->point * $request->quant[1]);
        ...
        if($request->quant){
            ...
            foreach ($request->quant as $k=>$quant) {
                ...
                if($quant > 0 && $cart) {
                    ...
                    $after_point = $cart->product->point;

                    $cart->amount = $after_price * $quant;
                    $cart->point_amount = $after_point * $quant;
                    // return $cart->price;
                    $cart->save();
