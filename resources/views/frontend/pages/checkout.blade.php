                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                <input name="payment_method" type="radio" value="cod"> <label> Cash On Delivery ($USD)</label><br>
                                                <input name="payment_method" checked type="radio" value="point"> <label> Pay with Point</label>
                                            </form-group>
